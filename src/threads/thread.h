...
enum thread_status
  {
    ...
    THREAD_SLEPT	/* Added : to indicate if thread is sleeping */
  };
...
void thread_set_priority_for_thread (struct thread *t, int new_priority);
...
void thread_set_cpu_burst_for_thread (struct thread *t, int new_priority);
void updateCPUBurst();
